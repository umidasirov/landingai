        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-gray-400 mb-8">
              Sanoat yetakchilari bilan tarmoq yarating, ilg‘or yechimlarni kashf eting va AIning sog‘liqni saqlash, moliya, robototexnika va tabiiy tilni qayta ishlash sohalariga qanday ta’sir qilayotganini bilib oling.
            </p>

            {/* Features */}
            <div className="grid grid-cols-2 gap-4 mb-12">
              {features.map((feature, i) => (
                <div key={i} className="flex items-center gap-3 p-4 bg-gradient-to-br from-purple-900/20 to-cyan-900/20 border border-purple-500/20 rounded-xl backdrop-blur-sm group transition-all">
